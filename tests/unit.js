...
describe('unit', function() {
    ...
    it('should build the correct cacheName', function() {
        expect(cachify._createCacheName([1,2,3])).to.equal('{011223');
        expect(cachify._createCacheName(['abc', 'asdf'])).to.equal('{0abc1asdf');

        expect(cachify._createCacheName([{a:1}, 'asdf'])).to.equal('{0{a11asdf');
        expect(cachify._createCacheName(['abc', [1,2]])).to.equal('{0abc1{0112');
    });
